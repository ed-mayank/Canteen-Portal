...
const statusButton = () => {
  ...
  if(i==0){
    setStatus("STATUS")
    var e = localStorage.getItem("status");
    if(e){
  ...
  if(i==1){
    ...
    localStorage.setItem("status","PLACED");
  }
  if(i==2){
    setStatus("ACCEPTED")
    var e = localStorage.getItem("status");
  ...
  if(i==4){
    ...
    localStorage.setItem("status","READY FOR PICKUP");
  }
  if(i==5){
    setStatus("COMPLETED")
    var e = localStorage.getItem("status");
              ...
              <TableBody>
                ...
                (
                  <TableRow key={ind}>
                    ...
                    <TableCell>
                    <Grid item xs={12}>
                            <Button variant="contained" onClick={()=>statusButton()} >{status}</Button>
                          </Grid>
                    </TableCell>
                    <TableCell>
                    <Grid item xs={12}>
                            <Button variant="contained" onClick={()=>rejectButton()} >{reject}</Button>
                          </Grid>
                    </TableCell>
                  </TableRow>
                )
